...
AResult := Integer(IBindCtx(CurrentObject).RegisterObjectParam(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),IUnknown(Integer(GetInputArg(1)))));
    ReturnOutputArg(AResult);
  end;
end;
...
AResult := Integer(IMoniker(CurrentObject).ParseDisplayName(IBindCtx(Integer(GetInputArg(0))),IMoniker(Integer(GetInputArg(1))),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),Param3,Param4));
    ReturnOutputArg(AResult);
    SetInputArg(3,Integer(Param3));
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(IStorage(CurrentObject).MoveElementTo(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),IStorage(Integer(GetInputArg(1))),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf)),VarToInteger(GetInputArg(3))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := IMoniker(Integer(GetInputArg(3)));
AResult := Integer(IParseDisplayName(CurrentObject).ParseDisplayName(IBindCtx(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
AResult := Integer(IOleItemContainer(CurrentObject).GetObject(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),VarToInteger(GetInputArg(1)),IBindCtx(Integer(GetInputArg(2))),TGUIDWrapper(integer(GetInputArg(3))).ObjToRec,Param4));
    ReturnOutputArg(AResult);
...
SetLength(Param0Buf, Length(VarToStr(GetInputArg(0))) + 1);
Param3 := GetInputArg(3);
AResult := Integer(IOleItemContainer(CurrentObject).GetObjectStorage(StringToWideChar(VarToStr(GetInputArg(0)),@Param0Buf[0],Length(Param0Buf)),IBindCtx(Integer(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(3,Param3);
  end;
end;
...
begin
  ...
  begin
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
AResult := Integer(IOleInPlaceUIWindow(CurrentObject).SetActiveObject(IOleInPlaceActiveObject(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
Param2 := VarToInteger(GetInputArg(2));
Param3 := IMoniker(Integer(GetInputArg(3)));
AResult := Integer(Ole2.MkParseDisplayName(IBindCtx(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),Param2,Param3));
    ReturnOutputArg(AResult);
    SetInputArg(2,Integer(Param2));
    SetInputArg(3,Integer(Param3));
  end;
...
SetLength(Param1Buf, Length(VarToStr(GetInputArg(1))) + 1);
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Ole2.RegisterTypeLib(ITypeLib(Integer(GetInputArg(0))),StringToWideChar(VarToStr(GetInputArg(1)),@Param1Buf[0],Length(Param1Buf)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
SetLength(Param2Buf, Length(VarToStr(GetInputArg(2))) + 1);
AResult := Integer(Ole2.WriteFmtUserTypeStg(IStorage(Integer(GetInputArg(0))),VarToInteger(GetInputArg(1)),StringToWideChar(VarToStr(GetInputArg(2)),@Param2Buf[0],Length(Param2Buf))));
    ReturnOutputArg(AResult);
  end;
end;
