...
begin
  with AMachine do
  begin
AResult := Integer(TCustomButtonClass(CurrentClass.ClassRef).Create(TComponent(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomButton(CurrentObject).CommandLinkHint);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).CommandLinkHint:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).DropDownMenu));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).DropDownMenu:=TPopupMenu(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).Images));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).Images:=TCustomImageList(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomButton(CurrentObject).ImageAlignment);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ImageAlignment:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCustomButton(CurrentObject).ImageMargins));
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ImageMargins:=TImageMargins(Integer(GetInputArg(0)));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomButton(CurrentObject).ModalResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCustomButton(CurrentObject).ModalResult:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(TCustomButton(CurrentObject).Style);
  end;
end;
