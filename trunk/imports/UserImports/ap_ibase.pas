...
type
  TatibaseLibrary = class(TatScripterLibrary)
    ...
    procedure __GetIBASE_DLL(AMachine: TatVirtualMachine);
  ...
  published
    ...
    property array_desc_scale: AnsiChar read Farray_desc_scale write Farray_desc_scale;
  ...
  published
    ...
    property bstr_mode: AnsiChar read Fbstr_mode write Fbstr_mode;
  end;
...
procedure TatibaseLibrary.__XSQLDA_LENGTH(AMachine: TatVirtualMachine);
  var
  AResult: variant;
begin
  with AMachine do
  begin
AResult := Integer(ibase.XSQLDA_LENGTH(VarToInteger(GetInputArg(0))));
    ReturnOutputArg(AResult);
  end;
end;

procedure TatibaseLibrary.__add_spb_length(AMachine: TatVirtualMachine);
  var
  Param0: PAnsiChar;
begin
  with AMachine do
...
Param0 := PAnsiChar(AnsiString(VarToStr(GetInputArg(0))));
    ibase.add_spb_length(Param0,VarToInteger(GetInputArg(1)));
    SetInputArg(0,string(Param0));
  end;
end;

procedure TatibaseLibrary.__add_spb_numeric(AMachine: TatVirtualMachine);
  var
  Param0: PAnsiChar;
begin
  with AMachine do
  begin
Param0 := PAnsiChar(AnsiString(VarToStr(GetInputArg(0))));
    ibase.add_spb_numeric(Param0,VarToInteger(GetInputArg(1)));
    SetInputArg(0,string(Param0));
  end;
end;

procedure TatibaseLibrary.__GetIBASE_DLL(AMachine: TatVirtualMachine);
begin
  with AMachine do
  begin
    ReturnOutputArg(string(ibase.IBASE_DLL));
  end;
end;

procedure TatibaseLibrary.Init;
  ...
  begin
    ...
    begin
      ...
      AddConstant('SQLDA_VERSION_CURRENT',SQLDA_VERSION_CURRENT);
      AddConstant('LENGTH_METANAMES',LENGTH_METANAMES);
      ...
      AddConstant('blr_boolean_dtype',blr_boolean_dtype);
  ...
  begin
    ...
    begin
      ...
      AddConstant('isc_dpb_set_db_charset',isc_dpb_set_db_charset);
      AddConstant('isc_dpb_gsec_attach',isc_dpb_gsec_attach);
      AddConstant('isc_dpb_address_path',isc_dpb_address_path);
      AddConstant('isc_dpb_process_id',isc_dpb_process_id);
      AddConstant('isc_dpb_no_db_triggers',isc_dpb_no_db_triggers);
      AddConstant('isc_dpb_trusted_auth',isc_dpb_trusted_auth);
      AddConstant('isc_dpb_process_name',isc_dpb_process_name);
      AddConstant('isc_dpb_trusted_role',isc_dpb_trusted_role);
      AddConstant('isc_dpb_org_filename',isc_dpb_org_filename);
      AddConstant('isc_dpb_utf8_filename',isc_dpb_utf8_filename);
      AddConstant('isc_dpb_ext_call_depth',isc_dpb_ext_call_depth);
      ...
      AddConstant('isc_dpb_set_group_commit',isc_dpb_set_group_commit);
      AddConstant('isc_dpb_gbak_validate',isc_dpb_gbak_validate);
      AddConstant('isc_dpb_client_interbase_var',isc_dpb_client_interbase_var);
      AddConstant('isc_dpb_admin_option',isc_dpb_admin_option);
      AddConstant('isc_dpb_flush_interval',isc_dpb_flush_interval);
      AddConstant('isc_dpb_instance_name',isc_dpb_instance_name);
      AddConstant('isc_dpb_old_overwrite',isc_dpb_old_overwrite);
      AddConstant('isc_dpb_archive_database',isc_dpb_archive_database);
      AddConstant('isc_dpb_archive_journals',isc_dpb_archive_journals);
      AddConstant('isc_dpb_archive_sweep',isc_dpb_archive_sweep);
      AddConstant('isc_dpb_archive_dumps',isc_dpb_archive_dumps);
      AddConstant('isc_dpb_archive_recover',isc_dpb_archive_recover);
      AddConstant('isc_dpb_recover_until',isc_dpb_recover_until);
      AddConstant('isc_dpb_force',isc_dpb_force);
      AddConstant('isc_dpb_preallocate',isc_dpb_preallocate);
      AddConstant('isc_dpb_sys_encrypt_password',isc_dpb_sys_encrypt_password);
      ...
      AddConstant('isc_dpb_shut_mode_mask',isc_dpb_shut_mode_mask);
      AddConstant('isc_dpb_shut_default',isc_dpb_shut_default);
      AddConstant('isc_dpb_shut_normal',isc_dpb_shut_normal);
      AddConstant('isc_dpb_shut_multi',isc_dpb_shut_multi);
      AddConstant('isc_dpb_shut_single',isc_dpb_shut_single);
      AddConstant('isc_dpb_shut_full',isc_dpb_shut_full);
      ...
      AddConstant('isc_tpb_no_savepoint',isc_tpb_no_savepoint);
      AddConstant('isc_tpb_lock_timeout',isc_tpb_lock_timeout);
      ...
      AddConstant('isc_spb_instance_name',isc_spb_instance_name);
      ...
      AddConstant('isc_spb_address_path',isc_spb_address_path);
      AddConstant('isc_spb_process_id',isc_spb_process_id);
      AddConstant('isc_spb_trusted_auth',isc_spb_trusted_auth);
      AddConstant('isc_spb_process_name',isc_spb_process_name);
      ...
      AddConstant('isc_spb_instance_name_mapped_to_server',isc_spb_instance_name_mapped_to_server);
      ...
      AddConstant('isc_info_db_reads',isc_info_db_reads);
      AddConstant('isc_info_db_writes',isc_info_db_writes);
      AddConstant('isc_info_db_fetches',isc_info_db_fetches);
      AddConstant('isc_info_db_marks',isc_info_db_marks);
      AddConstant('frb_info_att_charset',frb_info_att_charset);
      AddConstant('frb_info_db_class',frb_info_db_class);
      AddConstant('frb_info_firebird_version',frb_info_firebird_version);
      AddConstant('frb_info_oldest_transaction',frb_info_oldest_transaction);
      AddConstant('frb_info_oldest_active',frb_info_oldest_active);
      AddConstant('frb_info_oldest_snapshot',frb_info_oldest_snapshot);
      AddConstant('frb_info_next_transaction',frb_info_next_transaction);
      AddConstant('frb_info_db_provider',frb_info_db_provider);
      AddConstant('frb_info_active_transactions',frb_info_active_transactions);
      AddConstant('frb_info_active_tran_count',frb_info_active_tran_count);
      AddConstant('frb_info_creation_date',frb_info_creation_date);
      AddConstant('isc_info_db_code_rdb_eln',isc_info_db_code_rdb_eln);
      AddConstant('isc_info_db_code_rdb_vms',isc_info_db_code_rdb_vms);
      AddConstant('isc_info_db_code_interbase',isc_info_db_code_interbase);
      AddConstant('isc_info_db_code_firebird',isc_info_db_code_firebird);
  ...
  begin
    ...
    begin
      ...
      AddConstant('isc_action_svc_get_fb_log',isc_action_svc_get_fb_log);
      AddConstant('isc_action_svc_nbak',isc_action_svc_nbak);
      AddConstant('isc_action_svc_nrest',isc_action_svc_nrest);
      AddConstant('isc_action_svc_trace_start',isc_action_svc_trace_start);
      AddConstant('isc_action_svc_trace_stop',isc_action_svc_trace_stop);
      AddConstant('isc_action_svc_trace_suspend',isc_action_svc_trace_suspend);
      AddConstant('isc_action_svc_trace_resume',isc_action_svc_trace_resume);
      AddConstant('isc_action_svc_trace_list',isc_action_svc_trace_list);
      AddConstant('isc_action_svc_set_mapping',isc_action_svc_set_mapping);
      AddConstant('isc_action_svc_drop_mapping',isc_action_svc_drop_mapping);
      AddConstant('isc_action_svc_display_user_adm',isc_action_svc_display_user_adm);
      AddConstant('isc_action_svc_last',isc_action_svc_last);
      AddConstant('isc_spb_nbk_level',isc_spb_nbk_level);
      AddConstant('isc_spb_nbk_file',isc_spb_nbk_file);
      AddConstant('isc_spb_nbk_direct',isc_spb_nbk_direct);
      AddConstant('isc_spb_nbk_no_triggers',isc_spb_nbk_no_triggers);
      AddConstant('isc_spb_trc_id',isc_spb_trc_id);
      AddConstant('isc_spb_trc_name',isc_spb_trc_name);
      AddConstant('isc_spb_trc_cfg',isc_spb_trc_cfg);
      ...
      AddConstant('fb_cancel_disable',fb_cancel_disable);
      AddConstant('fb_cancel_enable',fb_cancel_enable);
      AddConstant('fb_cancel_raise',fb_cancel_raise);
      ...
      AddConstant('isc_spb_res_fix_fss_data',isc_spb_res_fix_fss_data);
      AddConstant('isc_spb_res_fix_fss_metadata',isc_spb_res_fix_fss_metadata);
      AddConstant('isc_spb_res_metadata_only',isc_spb_res_metadata_only);
      ...
      AddConstant('isc_spb_res_validate',isc_spb_res_validate);
      ...
      AddConstant('isc_spb_sts_record_versions',isc_spb_sts_record_versions);
      AddConstant('isc_spb_sts_table',isc_spb_sts_table);
      AddConstant('isc_spb_lck_sample',isc_spb_lck_sample);
      AddConstant('isc_spb_lck_secs',isc_spb_lck_secs);
      AddConstant('isc_spb_lck_contents',isc_spb_lck_contents);
      AddConstant('isc_spb_lck_summary',isc_spb_lck_summary);
      AddConstant('isc_spb_lck_wait',isc_spb_lck_wait);
      AddConstant('isc_spb_lck_stats',isc_spb_lck_stats);
      ...
      AddConstant('frb_info_sql_relation_alias',frb_info_sql_relation_alias);
      ...
      AddConstant('ISCCFG_TRACE_POOLS_KEY',ISCCFG_TRACE_POOLS_KEY);
      AddConstant('ISCCFG_REMOTE_BUFFER_KEY',ISCCFG_REMOTE_BUFFER_KEY);
      AddConstant('ISCCFG_CPU_AFFINITY_KEY',ISCCFG_CPU_AFFINITY_KEY);
      AddConstant('ISCCFG_SWEEP_QUANTUM_KEY',ISCCFG_SWEEP_QUANTUM_KEY);
      AddConstant('ISCCFG_USER_QUANTUM_KEY',ISCCFG_USER_QUANTUM_KEY);
      AddConstant('ISCCFG_SLEEP_TIME_KEY',ISCCFG_SLEEP_TIME_KEY);
      AddConstant('ISCCFG_MAX_THREADS_KEY',ISCCFG_MAX_THREADS_KEY);
      AddConstant('ISCCFG_ADMIN_DB_KEY',ISCCFG_ADMIN_DB_KEY);
      AddConstant('ISCCFG_USE_SANCTUARY_KEY',ISCCFG_USE_SANCTUARY_KEY);
      ...
      AddConstant('isc_arg_sql_state',isc_arg_sql_state);
  ...
  begin
    ...
    begin
      ...
      AddConstant('SQL_BOOLEAN',SQL_BOOLEAN);
      AddConstant('SQL_NULL',SQL_NULL);
...
begin
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_TIMESTAMP));
  Scripter.DefineRecordByRTTI(TypeInfo(TGDS_QUAD));
  Scripter.DefineRecordByRTTI(TypeInfo(TGDS__QUAD));
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_QUAD));
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_ARRAY_BOUND));
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_ARRAY_DESC));
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_BLOB_DESC));
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_BLOB_CTL));
  Scripter.DefineRecordByRTTI(TypeInfo(TBSTREAM));
  Scripter.DefineRecordByRTTI(TypeInfo(TXSQLVAR));
  Scripter.DefineRecordByRTTI(TypeInfo(TXSQLDA));
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_START_TRANS));
  Scripter.DefineRecordByRTTI(TypeInfo(TISC_TEB));
  Scripter.DefineRecordByRTTI(TypeInfo(TUserSecData));
  With Scripter.DefineClass(ClassType) do
  begin
    DefineMethod('XSQLDA_LENGTH',1,tkInteger,nil,__XSQLDA_LENGTH,false,0,'n: Long');
    DefineMethod('add_spb_length',2,tkNone,nil,__add_spb_length,false,0,'p: PAnsiChar; length: integer').SetVarArgs([0]);
    DefineMethod('add_spb_numeric',2,tkNone,nil,__add_spb_numeric,false,0,'p: PAnsiChar; data: integer').SetVarArgs([0]);
    DefineProp('IBASE_DLL',tkVariant,__GetIBASE_DLL,nil,nil,false,0);
  AddConsts1;
  AddConsts2;
  AddConsts3;
  AddConsts4;
...
class function TatibaseLibrary.LibraryName: string;
begin
  result := 'ibase';
end;

initialization
  RegisterScripterLibrary(TatibaseLibrary, True);
