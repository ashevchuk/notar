...
AResult := Integer(IClassFactory2(CurrentObject).CreateInstanceLic(IUnknown(Integer(GetInputArg(0))),IUnknown(Integer(GetInputArg(1))),TGUIDWrapper(integer(GetInputArg(2))).ObjToRec,StringToWideChar(VarToStr(GetInputArg(3)),@Param3Buf[0],Length(Param3Buf)),Param4));
    ReturnOutputArg(AResult);
