...
begin
  with AMachine do
  begin
AResult := Integer(TCommandPropertiesClass(CurrentClass.ClassRef).Create(TActionClientItem(Integer(GetInputArg(0)))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    TCommandProperties(CurrentObject).Assign(TPersistent(Integer(GetInputArg(0))));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCommandProperties(CurrentObject).Control));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TCommandProperties(CurrentObject).ActionClientItem));
  end;
end;
...
begin
  with AMachine do
  begin
    TCommandProperties(CurrentObject).ActionClientItem:=TActionClientItem(Integer(GetInputArg(0)));
  end;
end;
