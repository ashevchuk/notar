...
type
  TatIB_InstallHeaderLibrary = class(TatScripterLibrary)
...
procedure TatIB_InstallHeaderLibrary.Init;
begin
...
class function TatIB_InstallHeaderLibrary.LibraryName: string;
begin
  result := 'IB_InstallHeader';
end;

initialization
  RegisterScripterLibrary(TatIB_InstallHeaderLibrary, True);
