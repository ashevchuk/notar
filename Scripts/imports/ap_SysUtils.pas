...
type
  TatSysUtilsLibrary = class(TatScripterLibrary)
    FFormatSettings: SysUtils.TFormatSettings;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Integer(SysUtils.FloatToText(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,GetInputArg(2),GetInputArg(3),VarToInteger(GetInputArg(4)),VarToInteger(GetInputArg(5))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := Integer(SysUtils.FloatToTextFmt(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,GetInputArg(2),PAnsiChar(AnsiString(VarToStr(GetInputArg(3))))));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  ...
  begin
Param1 := GetInputArg(1);
AResult := SysUtils.TextToFloat(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),Param1,GetInputArg(2));
    ReturnOutputArg(AResult);
    SetInputArg(1,Param1);
  end;
end;
...
begin
  with AMachine do
  begin
AResult := SysUtils.StrByteType(PAnsiChar(AnsiString(VarToStr(GetInputArg(0)))),VarToInteger(GetInputArg(1)));
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.CurrencyString);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.CurrencyString:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(FFormatSettings.CurrencyFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.CurrencyFormat:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(FFormatSettings.NegCurrFormat));
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.NegCurrFormat:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.ThousandSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.ThousandSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.DecimalSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.DecimalSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(FFormatSettings.CurrencyDecimals));
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.CurrencyDecimals:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.DateSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.DateSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.ShortDateFormat);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.ShortDateFormat:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.LongDateFormat);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.LongDateFormat:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.TimeSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.TimeSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.TimeAMString);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.TimeAMString:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.TimePMString);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.TimePMString:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.ShortTimeFormat);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.ShortTimeFormat:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.LongTimeFormat);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.LongTimeFormat:=GetInputArg(0);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(FFormatSettings.TwoDigitYearCenturyWindow));
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.TwoDigitYearCenturyWindow:=VarToInteger(GetInputArg(0));
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(FFormatSettings.ListSeparator);
  end;
end;
...
begin
  with AMachine do
  begin
    FFormatSettings.ListSeparator:=VarToStr(GetInputArg(0))[1];
  end;
end;
...
begin
  FFormatSettings := SysUtils.TFormatSettings.Create;
