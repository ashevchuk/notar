...
begin
  with AMachine do
  begin
AResult := Integer(TStringStreamClass(CurrentClass.ClassRef).Create);
    ReturnOutputArg(AResult);
  end;
end;
...
begin
  with AMachine do
  begin
    ReturnOutputArg(Integer(TStringStream(CurrentObject).Encoding));
  end;
end;
...
begin
  ...
  begin
    ...
    AddConstant('FromBeginning',soFromBeginning);
    AddConstant('FromEnd',soFromEnd);
